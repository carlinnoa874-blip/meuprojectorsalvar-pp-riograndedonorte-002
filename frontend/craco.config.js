    ...
    devServerConfig.setupMiddlewares = (middlewares, devServer) => {
      ...
      middlewares.unshift({
        ...
        middleware: (req, res, next) => {
          /* Página inicial servida a partir de public/inicio.html */
          if (
            req.method === "GET" &&
          ...
          /* Página de inscrição - Contato */
          if (
            req.method === "GET" &&
            (req.path === "/inscricao/contato" || req.path === "/inscricao-contato" || req.path === "/inscricao-contato.html")
          ) {
            res.sendFile(path.resolve(__dirname, "public/inscricao-contato.html"));
            return;
          }
          /* Página de inscrição - Endereço */
          if (
            req.method === "GET" &&
            (req.path === "/inscricao/endereco" || req.path === "/inscricao-endereco" || req.path === "/inscricao-endereco.html")
          ) {
            res.sendFile(path.resolve(__dirname, "public/inscricao-endereco.html"));
            return;
          }
          /* Página de inscrição - Informações */
          if (
            req.method === "GET" &&
            (req.path === "/inscricao/informacoes" || req.path === "/inscricao-informacoes" || req.path === "/inscricao-informacoes.html")
          ) {
            res.sendFile(path.resolve(__dirname, "public/inscricao-informacoes.html"));
            return;
          }
          /* Página de inscrição - Confirmação */
          if (
            req.method === "GET" &&
            (req.path === "/inscricao/confirmacao" || req.path === "/inscricao-confirmacao" || req.path === "/inscricao-confirmacao.html")
          ) {
          ...
          if (
            req.method === "GET" &&
            (req.path === "/inscricao/pagamento" || req.path === "/inscricao-pagamento" || req.path === "/inscricao-pagamento.html")
          ) {
